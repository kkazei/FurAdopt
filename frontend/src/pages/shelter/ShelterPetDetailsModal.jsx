...
import { X, Edit, Trash2, Calendar, Stethoscope, Info, Users, Baby, Dog, Cat } from "lucide-react";
...
const ShelterPetDetailsModal = ({ isOpen, onClose, pet, onEdit, onDelete }) => {
	...
	return (
		<div className="modal-overlay" onClick={onClose}>
			<div className="modal-content shelter-pet-details-modal" onClick={(e) => e.stopPropagation()}>
				<div className="modal-header shelter-pet-details-header">
				...
				<div className="shelter-pet-details-body">
